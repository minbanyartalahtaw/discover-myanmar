...
import { allowPost, getPostForAdmin } from "./action";
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="relative">
        <Button variant={"default"}>Unapprove</Button>
        <Link href={'/admin/manage-posts/approve/1'}>
          <Button variant={"outline"} className="mx-2" >Approve</Button>
        </Link>
      ...
      <Pagination className="mt-10">
        <PaginationContent>
          <PaginationItem>
            <PaginationPrevious
              href={groupId > 1 ? `/admin/manage-posts/unapprove/${groupId - 1}` : '#'}
          ...
          {totalPages <= 5 ? (
            ...
            [...Array(totalPages)].map((_, index) => (
              <PaginationItem key={index}>
                <PaginationLink
                  href={`/admin/manage-posts/unapprove/${index + 1}`}
            ...
            <>
              ...
              <PaginationItem>
                <PaginationLink
                  href="/admin/manage-posts/unapprove/1"
                  isActive={groupId === 1}
                >
                  1
                </PaginationLink>
                ...
                return middlePages.map(pageNum => (
                  pageNum > 1 && pageNum < totalPages && (
                    <PaginationItem key={pageNum}>
                      <PaginationLink
                        href={`/admin/manage-posts/unapprove/${pageNum}`}
