...
import { getPost, getRelatedPostPosts } from "./action";
...
export default function Home() {
  ...
  const getMorePost = async () => {
    ...
    formData.append("regionId", post.regionId.toString());
    await getRelatedPostPosts(formData);
    setTimeout(() => {
      setLoadMore(false);
    }, 4000);
  };
